...
Read `references/principles.md`. Follow every `[[principles/<name>]]` link by reading the
corresponding `references/principles/<name>.md` file. These govern reviewer judgments.
...
loaded principles as your frame, state which findings you would accept and which you would reject —

...
- [Introduction to ast-grep Rules](#introduction-to-ast-grep-rules)
  - [Rule Categories](#rule-categories)
- [Anatomy of an ast-grep Rule Object](#anatomy-of-an-ast-grep-rule-object)
  - [General Structure](#general-structure)
  - [Rule Object Properties](#rule-object-properties)
- [Atomic Rules](#atomic-rules)
  - [pattern: String and Object Forms](#pattern-string-and-object-forms)
  - [kind: Matching by Node Type](#kind-matching-by-node-type)
  - [regex: Text-Based Node Matching](#regex-text-based-node-matching)
  - [nthChild: Positional Node Matching](#nthchild-positional-node-matching)
  - [range: Position-Based Node Matching](#range-position-based-node-matching)
- [Relational Rules](#relational-rules)
  - [inside: Matching Within a Parent Node](#inside-matching-within-a-parent-node)
  - [has: Matching with a Descendant Node](#has-matching-with-a-descendant-node)
  - [precedes and follows: Sequential Node Matching](#precedes-and-follows-sequential-node-matching)
  - [stopBy and field: Refining Relational Searches](#stopby-and-field-refining-relational-searches)
- [Composite Rules](#composite-rules)
  - [all: Conjunction (AND) of Rules](#all-conjunction-and-of-rules)
  - [any: Disjunction (OR) of Rules](#any-disjunction-or-of-rules)
  - [not: Negation (NOT) of a Rule](#not-negation-not-of-a-rule)
  - [matches: Rule Reuse and Utility Rules](#matches-rule-reuse-and-utility-rules)
- [Metavariables](#metavariables)
  - [$VAR: Single Named Node Capture](#var-single-named-node-capture)
  - [$$VAR: Single Unnamed Node Capture](#var-single-unnamed-node-capture)
  - [$$$MULTI_META_VARIABLE: Multi-Node Capture](#multi_meta_variable-multi-node-capture)
  - [Non-Capturing Metavariables (_VAR)](#non-capturing-metavariables-_var)
  - [Important Considerations for Metavariable Detection](#important-considerations-for-metavariable-detection)
- [Common Patterns and Examples](#common-patterns-and-examples)
  - [Finding Functions with Specific Content](#finding-functions-with-specific-content)
  - [Finding Code Inside Specific Contexts](#finding-code-inside-specific-contexts)
  - [Combining Multiple Conditions](#combining-multiple-conditions)
  - [Matching Multiple Alternatives](#matching-multiple-alternatives)
